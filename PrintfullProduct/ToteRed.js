const RedPrintfullSelector = require('./../Functions/Printfull/ToteRed/RegionSelector');
const setNumberMaps = require('../Functions/RegionNumbers/setRegionNumberTotesRed');
const toArray = require('lodash.toarray');
const axios = require('axios');

module.exports = product = (env, cantidad, req, nameFile, orderInfo) => {
    RedPrintfullSelector(setNumberMaps(toArray(cantidad).length), nameFile, req, orderInfo).then(() => {
