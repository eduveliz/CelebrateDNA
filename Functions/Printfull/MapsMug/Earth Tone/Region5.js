...
module.exports = createPreview = async (nameFile, properties, orderInfo) => {
    ...
    const colorProduct = datos[13].value;
    ...
    const headline = compasSelector(datos[11].value, font);
    let personalHeadline = datos[11].value === "First name / DNA" ? datos[12].value : "";
    ...
    compassTop = () => {
        if (datos[11].value === "First name / DNA") {
