...
module.exports = createPreview = async (nameFile, propiedades, orderInfo) => {
    ...
    //Headline
    const headline = datos[18].value === "Personalized headline" ? datos[19].value : datos[18].value;
    //FontSize
...
<div style="margin-top: 50px;margin-right: 20px">
    <div style="display: flex; justify-content: space-around;">
       ...
       ${sevenRegionNumber} %
        ...
        <div class="fontColorNumber" style="color:white;height:38px; width:100%;  border-radius: 20px; background-color: #7e4148;align-items: center;text-align: center;display: flex;justify-content: center;">
      ${eightRegionNumber} %
        </div>
    </div>
