...
module.exports = createPreview = async (nameFile, propiedades, orderInfo) => {
    ...
    const font = fontStyle(properties[10].value);
    const statement = properties[11].value;
    const personalStatementOne = statement === "Replicate the map on both sides" ? "" : properties[12].value;
    const personalStatementTwo = statement === "Replicate the map on both sides" ? "" : properties[13].value;
