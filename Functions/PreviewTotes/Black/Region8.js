...
<div style="margin-top: 50px;margin-right: 20px">
    <div style="display: flex; justify-content: space-around;">
       ...
       ${sevenRegionNumber} %
        ...
        <div class="fontColorRegion" style="height:38px; width:100%;  border-radius: 20px; background-color: #A4469A;align-items: center;text-align: center;display: flex;justify-content: center;font-size: 30px;">
      ${eightRegionNumber} %
        </div>
    </div>
    <div style="display: flex; justify-content: space-around;">
