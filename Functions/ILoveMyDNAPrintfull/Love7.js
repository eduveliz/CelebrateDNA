...
const fontSize = require('../FontSize/ILoveMyDNA/FontSizeLove7');
...
module.exports = createPreview = async (nameFile, propiedades) => {
    ...
    const font = fontStyle(datos[14].toString());
    const top = font === "Embossing" || font === "Funnier" ? "200px" : "190px";
...
<div style="display: flex;margin-left: 70px">
    ...
    <div class="region">
        <div style="margin-top: 30px">${firstRegionName} ${firstRegionNumber}%</div>
        ...
        <div style="margin-top: 30px">${fourRegionName} ${fourRegionNumber}%</div>
        <div style="margin-top: 30px">${fiveRegionName} ${fiveRegionNumber}%</div>
        <div style="margin-top: 30px">${sixRegionName} ${sixRegionNumber}%</div>
        <div style="margin-top: 30px">${sevenRegionName} ${sevenRegionNumber}%</div>
    </div>
</div>
</body>
</html>
