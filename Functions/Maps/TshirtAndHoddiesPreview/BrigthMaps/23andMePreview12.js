...
<div style="display: flex; justify-content:space-around;width:94%;margin-top: 50px;margin-left: 35px;">
    <div id="firstGroup" style="width: 100%;">
        ...
        <div style="height:60px; width:100%;display: flex; justify-content: flex-end;">
            <div style="width: 50%"></div>
            <div class="fontColor" style="width:50%;font-size: 25px;text-align: center;display: flex;justify-content: center;align-items: center">${secondRegionName}</div>
        </div>
    </div>
       ...
       <div id="secondGroup" style="width: 100%;">
        ...
        <div style="height:60px; width:100%;display: flex; justify-content: flex-end;">
            <div style="width: 50%"></div>
            <div class="fontColor" style="width:50%;font-size: 25px;text-align: center;display: flex;justify-content: center;align-items: center">${threeRegionName}</div>
        </div>
    </div>
   ...
   <div id="secondGroup" style="width: 100%;">
        ...
        <div style="height:60px; width:100%;display: flex; justify-content: flex-end;">
            <div style="width: 50%"></div>
            <div class="fontColor" style="width:50%;font-size: 25px;text-align: center;display: flex;justify-content: center;align-items: center">${sixRegionName}</div>
        </div>
    </div>
    ...
    <div id="sixGroup" style="width: 100%; ">
        ...
        <div style="display: flex; justify-content: space-around;height: 80px; ">
            ...
            <div  class="fontColor" style="color:white;height:38px;width: 100%; border-radius: 20px;margin-top: 32px; background-color: #EC008B;align-items: center;text-align: center;display: flex;justify-content: center;font-size: 30px;">
                ${twelveRegionNumber}%1
            </div>
        </div>
        <div style="height:60px; width:100%;display: flex; justify-content: flex-end;">
            <div style="width: 50%"></div>
            <div class="fontColor" style="color:white;font-size: 25px;width: 50%;text-align: center;display: flex;justify-content: center;align-items: center">${twelveRegionName}</div>
        </div>
    </div>
</div>
